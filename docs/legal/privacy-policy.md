...
- **Compliance**: We follow GDPR, COPPA, CCPA, and other privacy laws

**Children's Privacy**: We take special care with children's data. See [Section 10](#10-childrens-privacy-coppa-compliance) for details.
...
4. [Your Privacy Rights](#4-your-privacy-rights)
...
10. [Children's Privacy (COPPA Compliance)](#10-childrens-privacy-coppa-compliance)
11. [State-Specific Rights (CCPA, Virginia, Colorado)](#11-state-specific-rights)
...
- **Meal plans**: Meal names, recipes, ingredients, nutrition information
- **Budget and expenses**: Income, expense amounts, categories, descriptions
- **Documents**: Files, photos, receipts uploaded to Family Hub
...
- **Core Features**: Calendar, tasks, lists, meal planning, budget tracking
- **Event Chains**: Automated workflows based on your settings
- **Notifications**: Reminders for tasks, events, appointments
- **Collaboration**: Share calendars, lists with family members
- **Gamification**: Points, badges, rewards for children

### 2.2 To Improve the Service

- **Analytics**: Understand which features are most used (aggregated, anonymized data)
- **Performance**: Optimize load times, fix bugs, improve reliability
- **Research**: Identify pain points and opportunities for new features
- **A/B Testing**: Test different UX designs (with opt-out option)

### 2.3 To Communicate with You

- **Transactional Emails**: Account confirmations, password resets, receipts
- **Service Updates**: New features, maintenance windows, policy changes
- **Marketing (Optional)**: Product news, tips, promotions (you can opt out)
...
- **Abuse Prevention**: Identify and block spam, bots, malicious activity
- **Compliance**: Meet legal obligations (GDPR data subject requests, COPPA parental consent)
...
- **Legal Obligation**: To comply with laws (e.g., tax reporting, COPPA)

For children under 13, we rely on **verifiable parental consent**.
...
|----------|---------|-------------|----------|
| **Zitadel** | Authentication (OAuth) | Email, OAuth tokens | Germany (GDPR compliant) |
| **Stripe** | Payment processing | Email, billing address, payment info | USA (PCI DSS certified) |
| **DigitalOcean** | Cloud hosting | All service data (encrypted) | USA, Germany |
...
- **Legal Compliance**: Tax authorities, regulatory agencies
- **Safety**: To protect users from imminent harm
...
4. **Remediate**: Fix vulnerabilities and prevent recurrence
...
| Tasks and chores | Until deleted by user | Service provision |
| Shopping lists | Until deleted by user | Service provision |
| Payment history | 7 years | Tax and accounting compliance |
| Support tickets | 3 years | Customer service quality |
| Error logs | 1 year | Debugging and performance |
...
**Exception**: Premium/Family tier accounts are never auto-deleted (you're paying for storage).
...
Cookies are small text files stored on your device when you visit our website or use our app. They help us provide a better experience.
...
- **Compliance**: GDPR compliant, no cookies required
...
**Request a copy**: Email privacy@familyhub.app for our DPAs with third parties.
...
- ✅ Parents can review, delete, and control children's data
- ✅ Reasonable security measures to protect children's data

### 10.2 Parental Consent Process

**To add a child under 13:**

1. **Parent creates account**: Parent (18+) creates their own Family Hub account
2. **Add child member**: Parent clicks "Add Family Member" → Select "Child (under 13)"
3. **Enter child information**: First name, birthdate (for age verification)
4. **Consent email sent**: We send a consent email to the parent's verified email address
5. **Parent confirms**: Parent clicks "I give consent" link in the email
6. **Child account activated**: Child can now use Family Hub (with restrictions)
...
You requested to add Noah (birthdate: [redacted]) to your Family Hub account.

Because Noah is under 13, we need your consent to collect and use Noah's information.

By clicking the button below, you confirm that:
- You are Noah's parent or legal guardian
- You consent to our Privacy Policy (Children's Section)
- You understand Noah's data will be used for family coordination
...
You can view, modify, or delete Noah's data anytime from Family Settings.
...
- ✅ Points and badges earned (for gamification)
...
- ❌ Geolocation data (GPS coordinates, real-time location)
- ❌ Photos or videos of the child
- ❌ Social Security number
- ❌ Persistent identifiers for advertising or tracking
- ❌ Voice recordings
- ❌ Biometric data
...
- Display child's progress and rewards
...
- ❌ Selling child's data

### 10.5 Parental Rights & Controls
...
### 10.7 Transition to Teen Account (Age 13)

**When the child turns 13:**

1. **30 Days Before Birthday**: We email the parent:
   - "Noah will turn 13 on [date]"
   - "His account will automatically convert to a Teen account"
   - "Teen accounts have more features (can create events, lists)"

2. **On 13th Birthday**: Account automatically converts to Teen
   - Noah can now create calendar events
   - Noah can add items to shopping lists
   - Noah keeps all points, badges, and task history

3. **Parental Notification**: Parent receives confirmation email
   - "Noah's account is now a Teen account"
...
**We do NOT sell your personal information.** You have nothing to opt out of.

**No "Do Not Sell My Personal Information" link needed** because we don't engage in sales.
...
California residents can request information about our disclosure of personal information to third parties for their direct marketing purposes.
...
- You can contact the Virginia Attorney General if unsatisfied
...
### 11.4 Connecticut, Utah, and Other States
...
**Email**: privacy@familyhub.app
**Response Time**: Within 2 business days for general inquiries, 48 hours for data requests
...
### 13.3 COPPA Inquiries (Children Under 13)
...
**BY USING FAMILY HUB, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO THIS PRIVACY POLICY.**

**For children under 13**: Parent or guardian must accept this Privacy Policy on the child's behalf by providing verifiable parental consent.
