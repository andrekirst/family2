...
public class FakeGoogleAccountLinkRepository(GoogleAccountLink? existingLink = null) : IGoogleAccountLinkRepository
{
    ...
    public Task<GoogleAccountLink?> GetByUserIdAsync(UserId userId, CancellationToken cancellationToken = default)
    {
    ...
    public Task<GoogleAccountLink?> GetByGoogleAccountIdAsync(GoogleAccountId googleAccountId, CancellationToken cancellationToken = default)
    {
    ...
    public Task<List<GoogleAccountLink>> GetExpiringTokensAsync(DateTime expiringBefore, CancellationToken cancellationToken = default)
    {
    ...
    public Task AddAsync(GoogleAccountLink link, CancellationToken cancellationToken = default)
    {
        AddedLinks.Add(link);
