...
public sealed class DeleteSchoolYearAuthValidator : AbstractValidator<DeleteSchoolYearCommand>, IAuthValidator<DeleteSchoolYearCommand>
{
    public DeleteSchoolYearAuthValidator(
