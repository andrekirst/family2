...
public sealed class AssignStudentToClassAuthValidator : AbstractValidator<AssignStudentToClassCommand>, IAuthValidator<AssignStudentToClassCommand>
{
    public AssignStudentToClassAuthValidator(
