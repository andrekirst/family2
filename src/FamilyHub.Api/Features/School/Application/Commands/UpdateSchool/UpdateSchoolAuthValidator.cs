...
public sealed class UpdateSchoolAuthValidator : AbstractValidator<UpdateSchoolCommand>, IAuthValidator<UpdateSchoolCommand>
{
    public UpdateSchoolAuthValidator(
