...
public sealed class UpdateClassAssignmentAuthValidator : AbstractValidator<UpdateClassAssignmentCommand>, IAuthValidator<UpdateClassAssignmentCommand>
{
    public UpdateClassAssignmentAuthValidator(
