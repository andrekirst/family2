...
public sealed class RemoveClassAssignmentAuthValidator : AbstractValidator<RemoveClassAssignmentCommand>, IAuthValidator<RemoveClassAssignmentCommand>
{
    public RemoveClassAssignmentAuthValidator(
