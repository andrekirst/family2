...
public sealed class CreateSchoolYearAuthValidator : AbstractValidator<CreateSchoolYearCommand>, IAuthValidator<CreateSchoolYearCommand>
{
    public CreateSchoolYearAuthValidator(
