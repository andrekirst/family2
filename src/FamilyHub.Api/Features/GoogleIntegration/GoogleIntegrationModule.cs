...
using FamilyHub.Api.Features.GoogleIntegration.Endpoints;
...
[ModuleOrder(700)]
public sealed class GoogleIntegrationModule : IModule, IEndpointModule
{
    ...
    {
        app.MapGet("/api/google/callback", GoogleCallbackEndpoints.Callback);
    }
}
