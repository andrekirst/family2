...
namespace FamilyHub.Api.Migrations
{
    ...
    [Migration("20260304084128_AddStorageKeyToMessageAttachments")]
    partial class AddStorageKeyToMessageAttachments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FamilyHub.Api.Features.Photos.Domain.Entities.Photo", b =>
                {
                    ...
                    b.HasIndex("FamilyId", "CreatedAt")
                        .HasDatabaseName("ix_photos_family_id_created_at");

                    b.HasIndex("FamilyId", "IsDeleted")
                        .HasDatabaseName("ix_photos_family_id_is_deleted");
