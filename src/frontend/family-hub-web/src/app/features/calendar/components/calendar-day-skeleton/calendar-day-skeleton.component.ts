...
@Component({
  selector: 'app-calendar-day-skeleton',
  standalone: true,
  template: `
    <div class="bg-white shadow rounded-lg overflow-hidden" data-testid="day-skeleton">
      <!-- Day header placeholder -->
      <div class="grid grid-cols-[4rem_1fr] border-b border-gray-200">
        <div class="w-16"></div>
      ...
      <div class="overflow-hidden" style="height: 480px">
        @for (hour of hourPlaceholders; track hour) {
          <div class="grid grid-cols-[4rem_1fr] h-[60px] border-b border-gray-100">
...
export class CalendarDaySkeletonComponent {
