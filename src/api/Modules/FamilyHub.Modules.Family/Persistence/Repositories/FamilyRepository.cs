...
{
    /// <inheritdoc />
    public async Task<FamilyHub.Modules.Family.Domain.Family?> GetByIdAsync(FamilyId id, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task<FamilyHub.Modules.Family.Domain.Family?> GetFamilyByUserIdAsync(UserId userId, CancellationToken cancellationToken = default)
    {
    ...
    /// <inheritdoc />
    public async Task AddAsync(FamilyHub.Modules.Family.Domain.Family family, CancellationToken cancellationToken = default)
    {
