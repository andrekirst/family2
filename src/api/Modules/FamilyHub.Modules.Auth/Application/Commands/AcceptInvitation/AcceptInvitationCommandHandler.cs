    ...
    : IRequestHandler<AcceptInvitationCommand, FamilyHub.SharedKernel.Domain.Result<AcceptInvitationResult>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var invitation = validationCache.Get<FamilyHub.Modules.Family.Domain.FamilyMemberInvitation>($"FamilyMemberInvitation:{request.Token.Value}")
        ...
        var family = validationCache.Get<FamilyHub.Modules.Family.Domain.Family>($"Family:{invitation.FamilyId.Value}")
