...
public class FamilyType : ObjectType<FamilyHub.Modules.Family.Domain.Family>
{
    protected override void Configure(IObjectTypeDescriptor<FamilyHub.Modules.Family.Domain.Family> descriptor)
    {
        ...
        // TODO: Reimplement Members field - Family entity now only stores MemberIds, not full Member entities
        // Need to query Users separately using FamilyId
        descriptor
            .Field("members")
            ...
            .Resolve(ctx =>
            {
                // TODO: Query users by FamilyId instead
                return new List<FamilyMemberType>();
