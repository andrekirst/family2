...
/// <summary>
/// A batch scheduler for integration tests that provides explicit control over batch dispatch timing.
...
/// This is identical to the unit test fixture version but placed here for integration test access.
/// </remarks>
